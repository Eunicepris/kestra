...
public interface MultipleConditionStorageInterface {
    Optional<MultipleConditionWindow> get(FlowInterface flow, String conditionId);

    List<MultipleConditionWindow> expired(String tenantId);

    default MultipleConditionWindow getOrCreate(FlowInterface flow, MultipleCondition multipleCondition, Map<String, Object> outputs) {
